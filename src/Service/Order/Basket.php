...
use Service\Order\CheckoutBasket;
...
class Basket
{
    ...
    {
        $this->billing = $basketBuilder->setBilling();
        // Здесь должна быть некоторая логика выбора способа платежа
        $billing = new Card();

        $this->discount = $basketBuilder->setDiscount();
        // Здесь должна быть некоторая логика получения информации о скидке
        // пользователя
        $discount = new NullObject();

        $this->communication = $basketBuilder->setCommunication();
        // Здесь должна быть некоторая логика получения способа уведомления
        // пользователя о покупке
        $communication = new Email();

        $this->security = $basketBuilder->setSecurity();
        $security = new Security($this->session);

        return new ChekoutBasket($this);
    }
